    ...
    "📐 Matemáticas": {
        "subcategorias": {
            ...
            "Geometría": {
                ...
                "G06": {"label": "📏 G06: Triángulos", "render": render_G06},
                "G07": {"label": "📏 G07: Clasificación por ángulos", "render": render_G07},
                "G08": {"label": "📏 G08: Clasificación por lados", "render": render_G08},
                "G09": {"label": "📏 G09: Alturas y bisectrices", "render": render_G09},
                "G10": {"label": "📏 G10: Simetrales y transversales", "render": render_G10},
                "G11": {"label": "📏 G11: Teorema de Pitágoras", "render": render_G11},
                "G12": {"label": "📏 G12: Áreas y perímetros: triángulos y cuadriláteros", "render": render_G12},
                "G13": {"label": "📏 G13: Círculo y circunferencia", "render": render_G13},
                "G14": {"label": "📏 G14: Ángulos en la circunferencia", "render": render_G14},
                "G15": {"label": "📏 G15: Teorema de Euclides", "render": render_G15},
                "G16": {"label": "📏 G16: Teorema de Thales", "render": render_G16},
                "G17": {"label": "📏 G17: Semejanza de triángulos", "render": render_G17},
                "G18": {"label": "📏 G18: Homotecia", "render": render_G18},
                "G19": {"label": "📏 G19: Transformaciones isométricas", "render": render_G19},
                "G20": {"label": "📏 G20: 3D: Prismas y Cilindros", "render": render_G20},
                "G21": {"label": "📏 G21: 3D: Pirámides, conos y esfera", "render": render_G21},
                "V01": {"label": "🏹 V01: Introducción a Vectores", "render": render_V01},
                "V02": {"label": "🏹 V02: Operaciones con vectores", "render": render_V02},
                "V03": {"label": "🏹 V03: Largo de un vector", "render": render_V03},
                "V04": {"label": "🏹 V04: Isometrías", "render": render_V04},
                "V05": {"label": "🏹 V05: Vectores en 3D", "render": render_V05},
            ...
            "Probabilidad y Estadística": {
                ...
                "D02": {"label": "📊 D02: Visualizar datos", "render": render_D02},
                "D03": {"label": "📊 D03: Medidas de tendencia central", "render": render_D03},
                "D04": {"label": "📊 D04: Promedios", "render": render_D04},
                "D05": {"label": "📊 D05: Medidas de posición", "render": render_D05},
                "PB01": {"label": "🎲 PB01: Espacio muestral", "render": render_PB01},
                "PB02": {"label": "🎲 PB02: Regla de Laplace", "render": render_PB02},
                "PB03": {"label": "🎲 PB03: Probabilidad Compuesta", "render": render_PB03},
                "PB04": {"label": "🎲 PB04: Técnicas de conteo", "render": render_PB04},
                "PB05": {"label": "🎲 PB05: Variable aleatoria", "render": render_PB05},
            }
        }
    },
    "⚛️ Física": {
